...
public class MCalendarView extends ViewGroup {
    ...
    public MCalendarItemView mCurrentSelectedView = null;
            ...
            if (tagView != null) {
                ...
                for (int i = 0; i < pager.getChildCount(); i++) {
                    for (int j = 0; j < getChildCount(); j++) {
                        MCalendarItemView child = (MCalendarItemView) ((MCalendarView) pager.getChildAt(i)).getChildAt(j);
                        if (child == null) {
                            continue;
                        }
